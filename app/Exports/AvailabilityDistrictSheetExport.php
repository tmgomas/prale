...
class AvailabilityDistrictSheetExport implements FromView, WithTitle, WithEvents
{
    protected $district;
    protected $sports;
    ...
    public function view(): View
    {
        ...
        return view('reports.sports_availability', [
    ...
    public function registerEvents(): array
    {
        return [
            \Maatwebsite\Excel\Events\AfterSheet::class => function(\Maatwebsite\Excel\Events\AfterSheet $event) {
                ...
                // Set column width for data columns (M, W)
                ...
                // Add Page Break after "Elle" (using 2 columns per sport instead of 4)
                $colIndex = 1; // Start at A (1) is Division
                foreach ($this->sports as $sport) {
                    // Each sport takes 2 columns (M, W)
                    $colIndex += 2;
